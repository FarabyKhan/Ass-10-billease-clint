  ...
  return (
    <form onSubmit={handleLogin} className='flex justify-center min-h-screen my-30 items-center '>
      <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl ">
        <div className="card-body bg-blue-200/50 rounded-2xl shadow-2xl">
          <h1 className="text-5xl font-bold my-5 text-center">Login With</h1>
          <button className='flex justify-center items-center gap-1 '>
            <h1 className='text-5xl font-bold  text-blue-600 mb-10'>bill<span className='text-5xl
                      text-red-600'>ease</span></h1>
          </button>
          ...
          <fieldset className="fieldset space-y-3 ">
            ...
            <button
              ...
              className="btn btn-outline  bg-white text-black border-[#d2dbdb]  mt-1 mb-3">
